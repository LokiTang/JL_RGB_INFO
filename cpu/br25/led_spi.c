...
// #define USER_RGBLED_NUM 8
static u8 spi_dat_buf[24 * 16] __attribute__((aligned(4)));
...
void user_rgb_send_buf(u8 r, u8 g, u8 b, u32 index)
{
    led_spi_rgb_to_24byte(r, g, b, spi_dat_buf, index);

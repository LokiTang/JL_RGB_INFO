...
//*********************************************************************************//
/*软件IIC设置*/
#define TCHFG_SOFT_I2C_ENABLE               DISABLE_THIS_MOUDLE                     //软件IIC使能
#define TCFG_SW_I2C0_CLK_PORT               IO_PORTB_00                             //软件IIC  CLK脚选择
...
#define TCFG_SD0_ENABLE						0//ENABLE_THIS_MOUDLE
...
#define TCFG_KEEP_CARD_AT_ACTIVE_STATUS      1 //保持卡活跃状态
...
#undef USB_MEM_NO_USE_OVERLAY_EN
#define USB_MEM_NO_USE_OVERLAY_EN           0//必须为0,否则ram不够
...
#define AUDIO_EFFECTS_DVOL_AT_RAM           0
...
#define TCFG_PWMLED_ENABLE					1//DISABLE_THIS_MOUDLE			//是否支持PMW LED推灯模块
#define TCFG_PWMLED_IOMODE					LED_ONE_IO_MODE				//LED模式，单IO还是两个IO推灯
...
//VDDIO动态设置档位
#define TCFG_VDDIO_SET_DYNAMIC_EN           DISABLE //使能后 切换的过程会有轻微杂音
#define TCFG_VDDIO_DEV_MOUNT_LEVEL          VDDIOM_VOL_34V
#define TCFG_VDDIO_DEV_ACCESS_LEVEL         VDDIOM_VOL_34V

/*强VDDIO等级配置,可选：
    VDDIOM_VOL_20V    VDDIOM_VOL_22V    VDDIOM_VOL_24V    VDDIOM_VOL_26V
    VDDIOM_VOL_30V    VDDIOM_VOL_30V    VDDIOM_VOL_32V    VDDIOM_VOL_34V*/
#if TCFG_VDDIO_SET_DYNAMIC_EN
//VDDIO 设置的值要和vbat的压差要大于300mv左右，否则会出现DAC杂音，
//VDDIO 动态加载在TCFG_VDDIO_DEV_MOUNT_LEVEL、TCFG_VDDIO_DEV_ACCESS_LEVEL、
//TCFG_LOWPOWER_VDDIOM_LEVEL直接切换
...
#define TCFG_CODE_RUN_OVERLAY_FM_MODE               ENABLE_THIS_MOUDLE      //使能后FM模代码跑overlay_ram，否则跑malloc_ram
#else
#define TCFG_CODE_RUN_OVERLAY_FM_MODE               DISABLE_THIS_MOUDLE
#endif
...
#define TCFG_IIS_OUTPUT_PORT                  (0) // 0:portA  1:portB                  // 端口选择
...
#define TCFG_IIS_INPUT_PORT                  (0) // 0:portA  1:portB                   // 端口选择
...
#error "高阶音箱调音 不支持混响"
#endif
#if AUDIO_VBASS_CONFIG && TCFG_MIC_EFFECT_ENABLE
#error "混响、虚拟低音不支持同开"
#endif
...
#if ((RECORDER_MIX_EN && RECORDER_MIX_BT_PHONE_EN) && (AUDIO_VBASS_CONFIG && TCFG_DRC_ENABLE))
#error "AC696N 不支持虚拟低音和混合录音同时使用"
#endif
...
#if ((RECORDER_MIX_EN && RECORDER_MIX_BT_PHONE_EN) && (TCFG_SOUNDBOX_TOOL_ENABLE || TCFG_EFFECT_TOOL_ENABLE) && (TCFG_LED7_RUN_RAM))
#error "AC696N 不支持混合录音、在线调试工具、UI代码放ram同时使用"
#endif
